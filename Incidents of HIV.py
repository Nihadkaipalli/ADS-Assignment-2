# -*- coding: utf-8 -*-
"""
Created on Mon Dec 11 20:30:56 2023
...
def Life_Expectancy_Bargraph_1(Life_Expectancy):
    ...
    df_pivoted = df_filtered.pivot_table(
        index='Country Name', columns='Year', values='Incidence of HIV, all (per 1,000 uninfected population)')
    ...
    plt.title('Incidence of HIV, all (per 1,000 uninfected population)')
