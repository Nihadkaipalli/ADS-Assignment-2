# -*- coding: utf-8 -*-
"""
Created on Tue Dec 12 10:58:41 2023
...
def Life_Expectancy_Bargraph_1(Life_Expectancy):
    ...
    df_pivoted = df_filtered.pivot_table(
        index='Country Name', columns='Year', values='Antiretroviral therapy coverage for PMTCT (% of pregnant women living with HIV)')
    ...
    plt.title('Antiretroviral therapy coverage for PMTCT (% of pregnant women living with HIV)')
